...
router.get('/game/openGames', checkRole(ROLES.USER), GameController.getOpenGames);
...
router.post('/game/joinToPrivateGame', checkRole(ROLES.USER), GameController.joinToPrivateGame);
